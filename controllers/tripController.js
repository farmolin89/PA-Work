...
module.exports = (tripService, employeeService) => ({
    ...
    updateTrip: async (req, res, next) => {
        ...
        const { participants, startDate, endDate, ...tripDetails } = req.body;
        try {
            ...
            const finalUpdatedTrip = await tripService.update(tripId, { participants, startDate, endDate, ...tripDetails });
            if (!finalUpdatedTrip) {
